...
if dataset_type == 'synthetic':
	train_camera_path = 'dataset/nerf_synthetic/materials/transforms_train.json' 
	val_camera_path   = 'dataset/nerf_synthetic/materials/transforms_val.json' 
	train_image_path  = 'dataset/nerf_synthetic/materials'
	val_image_path    = 'dataset/nerf_synthetic/materials'
