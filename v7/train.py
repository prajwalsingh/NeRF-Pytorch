...
if __name__ == '__main__':
	...
	for epoch in range(START_EPOCH, END_EPOCH):
		...
		for idx, (image, c2wMatrix, _) in enumerate(tq, start=1):
			...
			del rgb_coarse, depth_map_coarse, weights_coarse, fine_rays, t_vals_fine, prediction, rgb_fine, depth_map_fine, weights_fine, loss
		# 	# break
		...
		if (epoch%config.vis_freq) == 0:
			...
			del rgb_final, depth_final, rgb_coarse, depth_map_coarse, weights_coarse, fine_rays, t_vals_fine, prediction, rgb_fine, depth_map_fine, weights_fine
